...
const ChatScreen = ({ navigation }) => {
  ...
  const chats = [
    ...
    { isChatbot: false, chatId: "Jennifer Nguyen", avatar: "https://i.imgur.com/amGUZ2X_d.jpg?maxwidth=520&shape=thumb&fidelity=high", status: "New Snap • 2h" },
    { isChatbot: false, chatId: "Team Snapchat", avatar: "https://i.imgur.com/DIbmxm0_d.jpg?maxwidth=520&shape=thumb&fidelity=high", status: "Received • 2h" },
    { isChatbot: false, chatId: "Cindy Lu", avatar: "https://i.imgur.com/oD5q8bL_d.jpg?maxwidth=520&shape=thumb&fidelity=high", status: "Opened • 2h" },
    { isChatbot: false, chatId: "Design Platforms Team", avatar: "https://i.imgur.com/D0NsSuA_d.jpg?maxwidth=520&shape=thumb&fidelity=high", status: "Received from Rajveer • 2h" },
    { isChatbot: false, chatId: "Cassie Lu", avatar: "https://i.imgur.com/BqG0x7t_d.jpg?maxwidth=520&shape=thumb&fidelity=high", status: "New Chat • 2h" }
  ];
  const requests = [
    { isChatbot: false, chatId: "Zack Lu", avatar: "https://i.imgur.com/nerBk7B_d.jpg?maxwidth=520&shape=thumb&fidelity=high", community: "data:image/png;base64,", status: "New Snap • 2h" },
    { isChatbot: false, chatId: "Isabella G", avatar: "https://i.imgur.com/2lXIQKF_d.jpg?maxwidth=520&shape=thumb&fidelity=high", community: "data:image/png;base64,", status: "New Snap • 2h" },
  ];
  const accepted = [
    { isChatbot: false, chatId: "Brian Wu", avatar: "https://i.imgur.com/Czjghz5_d.jpg?maxwidth=520&shape=thumb&fidelity=high", status: "Opened • 2h" },
    { isChatbot: false, chatId: "Jamie Adams", avatar: "https://i.imgur.com/x8Sex8h_d.jpg?maxwidth=520&shape=thumb&fidelity=high", status: "New Chat • 2h" }
  ];
